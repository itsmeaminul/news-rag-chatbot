...
class ChromaManager:
    ...
    def combined_search(self, query: str, source: str = None, category: str = None, n_results: int = 10) -> List[Dict]:
        """Combined semantic and metadata search with proper handling"""
        try:
            results = []
    ...
    def get_collection_stats(self) -> Dict:
        ...
        try:
            ...
            sample = self.collection.get(limit=min(200, count), include=['metadatas'])
...
def main():
    """Main function to test ChromaDB operations"""
    ...
    if success:
        # Test search
        query = "Bangladesh politics news"
